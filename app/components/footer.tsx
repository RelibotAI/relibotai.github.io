        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-md">
              AI-Powered Reliability for Smarter Industries - Helping organizations digitize processes and empower decisions with data.
            </p>
            <div className="flex space-x-4">
              ...
              <a href="https://www.linkedin.com/company/relibotai/" className="text-muted-foreground hover:text-primary transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="https://app.relibotai.com" className="text-muted-foreground hover:text-primary transition-colors">Demo</Link></li>
